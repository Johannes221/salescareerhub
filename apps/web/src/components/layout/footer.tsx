        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/fuer-unternehmen" className="hover:text-foreground transition-colors">Recruiting-Cockpit</Link></li>
              <li><Link href="/kontakt" className="hover:text-foreground transition-colors">Gespräch vereinbaren</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold mb-3">Für Kandidaten</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/jobs" className="hover:text-foreground transition-colors">Offene Positionen</Link></li>
              <li><Link href="/fuer-kandidaten" className="hover:text-foreground transition-colors">Karriere im SaaS</Link></li>

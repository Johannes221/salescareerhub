...
const STATUS_STYLES: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  recruiter_call: { bg: 'bg-violet-50', text: 'text-violet-700', dot: 'bg-violet-500' },
  briefing: { bg: 'bg-indigo-50', text: 'text-indigo-700', dot: 'bg-indigo-500' },
  hiring_team: { bg: 'bg-cyan-50', text: 'text-cyan-700', dot: 'bg-cyan-500' },
  contract_negotiation: { bg: 'bg-emerald-50', text: 'text-emerald-700', dot: 'bg-emerald-500' },
